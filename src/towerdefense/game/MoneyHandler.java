...
public class MoneyHandler {
     ...
     * @param killedEnemy The state of whether or not the user has killed an enemy since the last update
     * @param towerPurchased The state of whether or not the user has bought a tower since the last update
     */
    public void update(double secondsSurvived, Enemy killedEnemy, Tower towerPurchased){
        naturalUpdateMoney();
